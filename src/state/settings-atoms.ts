...
export type DownloadRateLimit = "unlimited" | "50K" | "100K" | "500K" | "1M" | "5M" | "10M";
...
export const maxFileSizeAtom = atomWithStorage<MaxFileSize>("maxFileSize", "unlimited");
...
export const appendUniqueIdAtom = atomWithStorage<boolean>("appendUniqueId", true);
