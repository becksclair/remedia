		...
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
				<DialogHeader>
					...
					<DialogDescription>Configure your download preferences and quality settings.</DialogDescription>
				</DialogHeader>
				...
				<div className="grid gap-6 py-4">
					...
					<div className="grid grid-cols-4 items-center gap-4">
						...
						<Select value={downloadMode} onValueChange={value => setDownloadMode(value as any)}>
						...
						<>
							...
							<div className="space-y-4">
								...
								<div className="grid grid-cols-4 items-center gap-4">
									...
									<Select value={videoFormat} onValueChange={value => setVideoFormat(value as any)}>
					...
					<div className="space-y-4">
						...
						<div className="grid grid-cols-4 items-center gap-4">
							...
							<Select value={audioFormat} onValueChange={value => setAudioFormat(value as any)}>
						...
						<div className="grid grid-cols-4 items-center gap-4">
							...
							<Select value={audioQuality} onValueChange={value => setAudioQuality(value as any)}>
